...
// (DO NOT EDIT: machine generated header) 'ogabout0.pas' rev: 29.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_OGABOUT0)
using namespace Ogabout0;
#endif
#pragma pack(pop)
#pragma option pop
