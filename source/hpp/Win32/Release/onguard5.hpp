...
// (DO NOT EDIT: machine generated header) 'onguard5.pas' rev: 29.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ONGUARD5)
using namespace Onguard5;
#endif
#pragma pack(pop)
#pragma option pop
