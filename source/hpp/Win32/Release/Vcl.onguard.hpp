...
// (DO NOT EDIT: machine generated header) 'Vcl.onguard.pas' rev: 30.00 (Windows)

#ifndef Vcl_OnguardHPP
#define Vcl_OnguardHPP
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TChangeCodeEvent)(System::TObject* Sender, const Vcl::Ogutil::TCode &Code);

typedef void __fastcall (__closure *TCheckedCodeEvent)(System::TObject* Sender, Vcl::Ogutil::TCodeStatus Status);

typedef void __fastcall (__closure *TGetCodeEvent)(System::TObject* Sender, Vcl::Ogutil::TCode &Code);

typedef void __fastcall (__closure *TGetKeyEvent)(System::TObject* Sender, Vcl::Ogutil::TKey &Key);
...
protected:
	...
	DYNAMIC void __fastcall DoOnChecked(Vcl::Ogutil::TCodeStatus Value);
	DYNAMIC Vcl::Ogutil::TCode __fastcall DoOnGetCode(void);
	DYNAMIC void __fastcall DoOnGetKey(Vcl::Ogutil::TKey &Key);
...
public:
	...
	virtual Vcl::Ogutil::TCodeStatus __fastcall CheckCode(bool Report) = 0 ;
...
public:
	...
	void __fastcall GetCode(Vcl::Ogutil::TCode &Value);
	void __fastcall SetCode(const Vcl::Ogutil::TCode &Value);
...
__published:
	__property Vcl::Ogutil::TCodeType CodeType = {read=FCodeType, write=FCodeType, default=0};
...
__published:
	__property System::UnicodeString About = {read=GetAbout, write=SetAbout, stored=false};
	__property System::UnicodeString KeyFileName = {read=FKeyFileName, write=FKeyFileName};
	__property Vcl::Ogutil::TKeyType KeyType = {read=FKeyType, write=FKeyType, default=0};
	__property bool ShowHints = {read=FShowHints, write=FShowHints, default=0};
public:
...
protected:
	...
	virtual void __fastcall Loaded(void);
	DYNAMIC void __fastcall DoOnChangeCode(const Vcl::Ogutil::TCode &Value);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_ONGUARD)
using namespace Vcl::Onguard;
#endif
