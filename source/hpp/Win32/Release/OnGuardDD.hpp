...
// (DO NOT EDIT: machine generated header) 'OnGuardDD.dpk' rev: 31.00 (Windows)
...
#include <SysInit.hpp>
#include <Vcl.ogabout0.hpp>
#include <Vcl.onguard5.hpp>
#include <Vcl.onguard6.hpp>
#include <Vcl.onguard7.hpp>
...
#include <Vcl.ogfirst.hpp>	// (OnGuardDR)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ONGUARDDD)
using namespace Onguarddd;
#endif
#pragma pack(pop)
#pragma option pop
