...
// (DO NOT EDIT: machine generated header) 'ogproexe.pas' rev: 29.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_OGPROEXE)
using namespace Ogproexe;
#endif
#pragma pack(pop)
#pragma option pop
