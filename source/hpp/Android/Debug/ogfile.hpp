...
// (DO NOT EDIT: machine generated header) 'ogfile.pas' rev: 29.00 (Android)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_OGFILE)
using namespace Ogfile;
#endif
#pragma pack(pop)
#pragma option pop
