...
// (DO NOT EDIT: machine generated header) 'ognetwrk.pas' rev: 29.00 (Android)
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TOgNetCode : public Onguard::TOgCodeBase
{
	typedef Onguard::TOgCodeBase inherited;
...
extern DELPHI_PACKAGE bool __fastcall CreateNetAccessFile(const System::UnicodeString FileName, const Ogutil::TKey &Key, System::Word Count);
extern DELPHI_PACKAGE bool __fastcall CreateNetAccessFileEx(const System::UnicodeString FileName, const Ogutil::TKey &Key, const Ogutil::TCode &Code);
extern DELPHI_PACKAGE int __fastcall DecodeNAFCountCode(const Ogutil::TKey &Key, const Ogutil::TCode &Code);
extern DELPHI_PACKAGE void __fastcall EncodeNAFCountCode(const Ogutil::TKey &Key, unsigned Count, Ogutil::TCode &Code);
extern DELPHI_PACKAGE bool __fastcall GetNetAccessFileInfo(const System::UnicodeString FileName, const Ogutil::TKey &Key, TNetAccessInfo &NetAccessInfo);
extern DELPHI_PACKAGE bool __fastcall IsAppOnNetwork(const System::UnicodeString ExePath);
extern DELPHI_PACKAGE bool __fastcall LockNetAccessFile(const System::UnicodeString FileName, const Ogutil::TKey &Key, TNetAccess &NetAccess);
extern DELPHI_PACKAGE bool __fastcall ResetNetAccessFile(const System::UnicodeString FileName, const Ogutil::TKey &Key);
extern DELPHI_PACKAGE bool __fastcall UnlockNetAccessFile(TNetAccess &NetAccess);
}	/* namespace Ognetwrk */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_OGNETWRK)
using namespace Ognetwrk;
#endif
#pragma pack(pop)
#pragma option pop
