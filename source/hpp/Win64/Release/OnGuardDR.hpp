...
// (DO NOT EDIT: machine generated header) 'OnGuardDR.dpk' rev: 29.00 (Windows)
...
#include <Vcl.onguard2.hpp>
#include <Vcl.onguard3.hpp>
#include <Vcl.onguard4.hpp>
#include <Vcl.ogfile.hpp>
#include <Vcl.ogfirst.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ONGUARDDR)
using namespace Onguarddr;
#endif
#pragma pack(pop)
#pragma option pop
