...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TChangeCodeEvent)(System::TObject* Sender, Ogutil::TCode Code);
...
public:
	...
	void __fastcall SetCode(Ogutil::TCode Value);
...
protected:
	...
	virtual void __fastcall Loaded(void);
	DYNAMIC void __fastcall DoOnChangeCode(Ogutil::TCode Value);
