...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TChangeCodeEvent)(System::TObject* Sender, Vcl::Ogutil::TCode Code);
...
public:
	...
	void __fastcall SetCode(Vcl::Ogutil::TCode Value);
...
protected:
	...
	virtual void __fastcall Loaded(void);
	DYNAMIC void __fastcall DoOnChangeCode(Vcl::Ogutil::TCode Value);
